...
@section('content')
    <div id="app" class="row justify-content-center mb-3">
        <div class="col-sm-12">
            <div class="card rounded-0 shadow-sm mb-5">
                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="card border shadow-md rounded-sm p-2">
                                <form action="{{ route('admin.category-menus.store') }}" method="post">
                                    @csrf
                                    <div class="card-header p-2">
                                        <button type="submit" class="btn btn-sm btn-success ml-auto d-block">Add To List</button>
                                    </div>
